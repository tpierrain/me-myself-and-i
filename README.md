...
VP of Technology chez Shodo, Thomas construit du logiciel depuis presque trois décennies, en tant qu'entrepreneur, consultant, architecte et eXtreme Programmer. Ancien VP Engineering d'une scale-up européenne en forte croissance, il défend avec conviction une approche use-case-driven, à rebours du réflexe « solution d'abord » de notre industrie.

Co-organisateur du DDD France et ancien du BDD Paris, il s'appuie sur l'autonomie, le DDD et le TDD pour aider les équipes à livrer de meilleurs logiciels, plus vite et plus durablement. Depuis plus de quinze ans, il pratique le flow et le continuous delivery, et conduit le change management nécessaire pour vraiment les ancrer dans les organisations. Passionné par le product management et le Domain Driven Design, il a passé ces cinq dernières années à rapprocher le produit et la tech, et à rendre leur collaboration bien plus efficace. __Plus de 100 talks donnés dans le monde depuis 2014__ (beaucoup de live-codings, de conférences, de keynotes, etc.).
