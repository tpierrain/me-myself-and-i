...
## Bio
VP of Technology at Shodo, Thomas has spent nearly three decades building software as an entrepreneur, consultant, architect, and eXtreme Programmer. A seasoned technical architect, he cut his teeth on demanding systems: low latency, high availability, bitemporal event-sourcing, and CQRS. Former VP Engineering in a fast-growing European scale-up, he strongly advocates for a use-case-driven approach, pushing back against our industry's habitual solution-first reflex.

Co-organizer of DDD France and former BDD Paris, he relies on autonomy, DDD, and TDD to help teams deliver better software, faster and more sustainably. A long-time hexagonal architecture advocate, he even got to live-code it on stage with its creator, Alistair Cockburn, and has since shaped his own patterns and practices, like The Hive (a modular monolith you can slice into microservices anytime) and Outside-in Diamond TDD. For over fifteen years, he has practiced flow and continuous delivery, and led the change management it takes to make them truly stick inside organizations. A product management and Domain-Driven Design enthusiast, he has spent the last five years bringing product and engineering closer together, and making their collaboration far more effective. __More than 100 talks made worldwide since 2014__ (lots of live-coding sessions, talks, keynotes, etc.).

These days, that same craft, now paired with AI, pulls him toward a bigger goal: augmenting people and organizations rather than replacing them. He notably builds Kenjaku, an open-source Second Brain Generator, and helps companies move from scattered AI tinkering to a real collective augmentation strategy, one that brings every team on board without falling into the trap of local optimizations.
...
VP of Technology chez Shodo, Thomas construit du logiciel depuis presque trois décennies, en tant qu'entrepreneur, consultant, architecte et eXtreme Programmer. Architecte technique chevronné, il a fait ses armes sur des systèmes exigeants : faible latence, haute disponibilité, event-sourcing bitemporel et CQRS. Ancien VP Engineering d'une scale-up européenne en forte croissance, il défend avec conviction une approche use-case-driven, à rebours du réflexe « solution d'abord » de notre industrie.

Co-organisateur du DDD France et ancien du BDD Paris, il s'appuie sur l'autonomie, le DDD et le TDD pour aider les équipes à livrer de meilleurs logiciels, plus vite et plus durablement. Ambassadeur de longue date de l'architecture hexagonale, il a même eu le privilège de la live-coder sur scène avec son créateur, Alistair Cockburn, et a depuis façonné ses propres patterns et pratiques, comme The Hive (un monolithe modulaire que l'on peut découper en microservices à tout moment) et l'Outside-in Diamond TDD. Depuis plus de quinze ans, il pratique le flow et le continuous delivery, et conduit le change management nécessaire pour vraiment les ancrer dans les organisations. Passionné par le product management et le Domain Driven Design, il a passé ces cinq dernières années à rapprocher le produit et la tech, et à rendre leur collaboration bien plus efficace. __Plus de 100 talks donnés dans le monde depuis 2014__ (beaucoup de live-codings, de conférences, de keynotes, etc.).

Aujourd'hui, ce même artisanat, désormais couplé à l'IA, le pousse vers un objectif plus grand : augmenter les gens et les organisations, jamais les remplacer. Il construit notamment Kenjaku, un Second Brain Generator open source, et aide les entreprises à passer du tâtonnement IA à une vraie stratégie d'augmentation collective, qui embarque toutes les équipes sans tomber dans le piège des optimisations locales.
...
#### Café Craft podcast
 - __CQRS et EventSourcing__ https://podcasts.apple.com/fr/podcast/larchitecture-cqrs-et-eventsourcing-avec-thomas-pierrain/id1294016248?i=1000433850284  and https://www.cafe-craft.fr/32-bonus  ![podcast](podcast.png)
